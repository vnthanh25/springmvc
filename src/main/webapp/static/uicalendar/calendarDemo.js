 ...
 */
var calendarDemoApp = angular.module('calendarDemoApp', ["ngRoute", 'ui.calendar', 'ui.bootstrap']);
...
calendarDemoApp.controller('CalendarCtrl',
   function($scope,$compile,uiCalendarConfig) {
    ...
    /* event sources array*/
    $scope.eventSources3 = [$scope.events, $scope.eventSource, $scope.eventsF];
    $scope.eventSources2 = [$scope.calEventsExt, $scope.eventsF, $scope.events];
    $scope.eventSources1 = [$scope.events1, $scope.events];
